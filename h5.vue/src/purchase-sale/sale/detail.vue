...
import { getSaleOrderDetail } from '@/services/new-order'
import type { GetSaleOrderDetailDto } from '@/types/new-order'
...
// 获取销售订单详情
const orderDetail = ref<GetSaleOrderDetailDto>()
const getOrderDetail = async () => {
  const res = await getSaleOrderDetail(query.id)
    ...
    <template v-if="orderDetail">
      ...
      <view class="shipment">
        <view class="locate">
          ...
          />
          <uni-tag
            :text="getSaleOrderStatusItem(orderDetail.saleOrderStatus).text"
            :type="getSaleOrderStatusItem(orderDetail.saleOrderStatus).tagType"
            :inverted="true"
            size="small"
          />
        </view>
      ...
      <view class="goods">
        ...
        <view class="total">
          <view class="row">
            <view class="text">销售总价: </view>
            <view class="symbol">{{ orderDetail.sumSalePrice }}</view>
          </view>
          <view class="row">
