<template>
  <div class="main-container">
    <n-card :title="editData.title" style="margin-bottom: 16px">
      ...
      <DataForm
        ref="submitForm"
        :options="CreateReturnOrderFormOptions"
        :form-config="{
          labelWidth: 100,
          size: 'medium',
          labelAlign: 'right',
...
<script lang="ts">
  import { ReturnOrderApi, productApi } from '@/api/url'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      //创建退货订单
      const CreateReturnOrderFormOptions = [
        {
          key: 'id',
          value: ref(null),
          hidden: true,
